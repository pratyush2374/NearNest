            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center md:gap-2 ">
                        <Link
                            href="/feed"
                            className="hidden md:flex items-center md:pace-x-2"
                        >
                        ...
                        <Popover>
                            ...
                            >
                                <div className="space-y-1">
                                    <Link href="/feed" className="md:hidden flex items-center space-x-3 px-3 py-2 rounded-md hover:bg-gray-50 transition-colors duration-150 cursor-pointer group">
                                        <div className="flex-shrink-0">
